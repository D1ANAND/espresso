/**
 * Example: Espresso + Citrea Schnorr Verification Integration
...
// import { BitcoinCommandEncoder, BitcoinFunctionEncoder } from '@espresso/sdk';

console.log('=== Espresso + Citrea Schnorr Integration Example ===\n');
...
const CITREA_TESTNET = {
  ...
  contracts: {
    EspressoReceiver: '0x...',       // Deploy EspressoMessageReceiver
    exampleTarget: '0x...',      // Deploy ExampleTargetContract
  },
};

console.log('Citrea Testnet Chain ID:', CITREA_TESTNET.chainSelector);
console.log('Espresso Receiver:', CITREA_TESTNET.contracts.EspressoReceiver);
...
// ============================================
// Step 4: Encode Complete Espresso Payload
// ============================================
console.log('Step 4: Encode Espresso Payload');
console.log('─────────────────────────────────────────────');

// NOTE: Authorization field requires extending BitcoinCommandEncoder
// For now, showing the conceptual structure:
const EspressoPayloadStructure = {
  protocol: '0x4243',
...
console.log('Espresso Payload Structure:');
console.log(JSON.stringify(EspressoPayloadStructure, null, 2));
console.log();

// Using current SDK (without authorization) - conceptual:
// const EspressoPayload = BitcoinCommandEncoder.encodeJSON(
//   'CITREA_TESTNET',
...
console.log('Current Espresso Payload (without authorization):');
...
Bitcoin Transaction:
{
  ...
  outputs: [
    {
      value: 0,
      scriptPubKey: "OP_RETURN <EspressoPayload>"  // ← Your message
    },
    {
      value: remaining,
...
console.log(`
EspressoMessageReceiver.sol:

function receiveMessage(
    bytes32 txid,
    EspressoMessage calldata message,
...
console.log('1. Deploy EspressoMessageReceiver and ExampleTargetContract on Citrea Testnet');
console.log('2. Configure relayer to forward to EspressoMessageReceiver');
